public class Lab {
    ...
    public String decide(int n){
        // if after dividing n by 2 yields 0 => then 'n' is "Even"
        if(n % 2 == 0)
            return("Even");
        // if(n % 2 == 1) ... => 'n' is "Odd"
        else
        ...
        // Note: This may look odd w/o squiggly brackets {} but for one-liners its typically fine -- stylistically not really my cuppa tea
    }
}
